...
VIRAL_QUESTIONS = [
    ...
    # 🧠 심리/관상 계열
    "저 눈빛... 진짜 무섭다! 심리전 1등은 누구?",
    "말은 부드럽지만 속은 강철! 진짜 독종은 누구?",
    "웃고 있어도 믿으면 안 될 것 같은 사람은?",
    "저 표정... 뭔가 숨기고 있다! 포커페이스 1위는?",
    "처음엔 몰랐는데 갈수록 무서워지는 사람은?",

    # 💬 말빨/입담 계열
    "저 말 한마디에 여론이 뒤집혔다! 최강 언변은?",
    "기자들이 가장 무서워했을 것 같은 사람은?",
    "토론 상대로 만나면 가장 피하고 싶은 사람은?",
    "말 실수 한 방에 스스로 무덤 판 사람은?",
    "명언 하나는 끝내준다! 최고의 어록 보유자는?",

    # 🎬 이미지/브랜딩 계열
    "이미지 관리 하나는 천재적이었던 사람은?",
    "국민 앞에서 가장 완벽한 '연출'을 했던 사람은?",
    "카메라 앞에서 가장 자연스러운 사람은?",
    "유튜브 채널 열면 구독자 가장 많을 것 같은 사람은?",
    "예능 출연하면 가장 웃길 것 같은 정치인은?",

    # 🤝 인간관계/신뢰 계열
    "가장 오래, 가장 많은 사람에게 사랑받은 사람은?",
    "뒤에서도 욕 안 할 것 같은 진짜 인격자는?",
    "서민들과 가장 잘 어울릴 것 같은 사람은?",
    "위기 때 가장 먼저 연락하고 싶은 사람은?",
    "내 편이 되어주면 가장 든든할 것 같은 사람은?",

    # ⚡ 능력/업적 계열
    "경제 하나만큼은 진짜 잘했다고 인정받는 사람은?",
    "외교 무대에서 가장 빛났던 사람은?",
    "위기 상황에서 가장 냉철하게 판단했을 것 같은 사람은?",
    "혼자 나라 이끌었어도 버텼을 것 같은 사람은?",
    "미래를 가장 먼저 내다봤던 선견지명의 인물은?",

    # 😤 반전/역주행 계열
    "지금 다시 보면 사실 맞는 말이었다! 재평가 1위는?",
    "당시엔 욕 먹었지만, 지금 생각하면 옳았던 사람은?",
    "시대를 너무 앞서갔던 비운의 정치인은?",
    "역사가 결국 복권시켜줄 것 같은 사람은?",
    "10년 뒤엔 다르게 평가받을 것 같은 사람은?",
]
