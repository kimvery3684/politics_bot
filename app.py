...
# --- [1. 기본 설정 및 영구 저장소] ---
st.set_page_config(page_title="JJ 쇼츠 마스터 1호점 (바이럴)", page_icon="🔥", layout="wide")
...
with col_R:
    ...
    st.download_button("💾 이미지 다운로드", buf.getvalue(), "shorts_viral_1.jpg", "image/jpeg", use_container_width=True)